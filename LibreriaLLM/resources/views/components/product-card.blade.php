    ...
    <div class="card-body">
        ...
        @if (isset($cart))
            ...
            >
                @csrf
                @method('DELETE')
                <button type="submit" class="btn btn-warning" style="width: 100%;">Borrar del carrito</button>
            </form>
        @else
            <form
                class="d-inline"
            ...
            >
                @csrf
                <button type="submit" class="btn btn-success" style="width: 100%;">Añadir al carrito</button>
            </form>
        @endif
    </div>
</div>
